...
ULOOP_BINARY(u_fmodqd, fmodqd, ddouble, ddouble, double)
ULOOP_BINARY(u_fmoddq, fmoddq, ddouble, double, ddouble)
ULOOP_BINARY(u_fmodqq, fmodqq, ddouble, ddouble, ddouble)
...
static int register_ufuncs()
{
    bool ok = register_unary(u_negq, type_num, "negative")
        ...
        && register_binary(u_fmoddq, u_fmodqd, u_fmodqq, type_num, "fmod")
